...
void loop() {
  ...
  if(t == 119){          //move reverse(all motors rotate in forward direction)
  ...
  else if(t == 97){    //move forward (all motors rotate in reverse direction)
  ...
  else if(t == 115){    //STOP (all motors stop)
